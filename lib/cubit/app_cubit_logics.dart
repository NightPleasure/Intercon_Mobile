    ...
    return Scaffold(
      body: BlocBuilder<AppCubits,CubitStates>(
        builder: (context,state){
          ...
          else if(state is LoadingState) return Center(child: CircularProgressIndicator(),);
          else if(state is LoadedState) return MainPage();
          else if(state is DetailState) return DetailsPage();
